...
namespace Dev_Talks\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( DEV_TALKS_TEMP_DIR ), $directory, $file_name );
...
spl_autoload_register( '\Dev_Talks\Inc\Helpers\autoloader' );
